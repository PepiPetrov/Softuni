function PriceStudioAndApartment(month,nights) {
    ...
    let apInfo=`Apartment: ${apartmentPrice.toFixed(2)} lv.`
    let stInfo=`Studio: ${studioPrice.toFixed(2)} lv.`
    console.log(apInfo);
    console.log(stInfo)
}

PriceStudioAndApartment('August',20)
